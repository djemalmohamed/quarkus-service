...
public record SignatureData(
     ...
     *
     * @param signature raw decoded {@code Signature} bytes
    ...
    public SignatureData {
        signature = null == signature ? null : Arrays.copyOf(signature, signature.length);
     ...
     *
     * @return decoded signature bytes, or {@code null} when unavailable
     */
    @Override
